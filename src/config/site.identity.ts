export const siteIdentity = {
  ...
  tagline: process.env.NEXT_PUBLIC_SITE_TAGLINE || 'Cybersecurity insights and technical articles',
  description:
    process.env.NEXT_PUBLIC_SITE_DESCRIPTION ||
    'An editorial platform for publishing technical articles, product commentary, and cybersecurity-focused insights.',
