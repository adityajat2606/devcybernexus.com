...
import { AuthLoginForm } from '@/components/shared/auth-login-form'
...
function getLoginConfig(kind: ReturnType<typeof getProductKind>) {
  ...
  if (kind === 'editorial') {
    return {
      ...
      panel: 'border border-neutral-200 bg-white shadow-[0_24px_80px_rgba(0,0,0,0.06)]',
      side: 'border border-neutral-200 bg-[linear-gradient(160deg,#fff5ed_0%,#ffffff_55%)]',
      muted: 'text-neutral-600',
      action: 'bg-[#FF5C00] text-white hover:bg-[#e65300]',
      icon: FileText,
      title: 'Sign in to your reading workspace',
      body: 'Access saved preferences and continue where you left off. Your session is stored locally in this browser.',
    }
  }
  if (kind === 'visual') {
    return {
